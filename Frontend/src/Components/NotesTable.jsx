      ...
      <table className='w-full border-separate border-spacing-4 p-4 mt-8'>
        ...
        <tbody>
          <tr>
            ...
            <td className='max-md:hidden border-purple-600 border-2 rounded-md p-2'>Completed</td>
