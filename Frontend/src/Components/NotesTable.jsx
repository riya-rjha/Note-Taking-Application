...
const NotesTable = () => {
  ...
  const fetchNotes = async () => {
    try {
      ...
      console.log(notesData.data.data);
      console.log(notesData.data.data[0].topic);
      console.log(notesData.data.data[0].status);
      console.log(notesData.data.data[0].createdAt);
    } catch (error) {
