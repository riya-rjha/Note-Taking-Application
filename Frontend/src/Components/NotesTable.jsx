      ...
      <table className='w-full border-separate border-spacing-4 p-4 mt-4'>
        ...
        <tbody>
          <tr>
            ...
            <td contentEditable='true' className='border-purple-600 border-2 rounded-md p-2'>ReactJS</td>
            <td contentEditable='true' className='max-md:hidden outline-none border-purple-600 border-2 rounded-md p-2'>Ongoing</td>
            <td className='max-md:hidden border-purple-600 border-2 rounded-md p-2'>13/02/2023</td>
            <td>
              <p contentEditable='true' className='border-purple-600 border-2 outline-none rounded-md p-2'>
        ...
        <tbody>
          <tr>
            ...
            <td contentEditable='true' className=' border-purple-600 border-2 rounded-md p-2'>JavaScript</td>
            <td contentEditable='true' className='max-md:hidden outline-none border-purple-600 border-2 rounded-md p-2'>Ongoing</td>
        ...
        <tbody>
          <tr>
            ...
            <td contentEditable='true' className=' border-purple-600 border-2 rounded-md p-2'>Postman API</td>
            <td contentEditable='true' className='max-md:hidden border-purple-600 border-2 rounded-md outline-none p-2'>Completed</td>
