...
const Searchbar = ({ onSearch }) => {
  ...
  return (
    <div className='flex items-center justify-center w-full max-w-[1190px]'>
      ...
      />
      <button className='border text-xl outline-none p-4 w-40 bg-red-200 text-red-950 hover:bg-red-300 transition-all delay-75 hover:text-emerald-950' onClick={handleSearchClick}>Search</button>
    </div>
  );
};
